...
gen_srk_from_template "$SCRIPT_DIR/cmake/config/imx_authenticated_hab.cmake_template" "$TEMP_HAB_FILE"
...
"$SCRIPT_DIR/cmake/config/elftosb_wrapper.sh"  "$TOOL_PATH" "$TOOL_PATH" -f imx -V -c "$TEMP_HAB_FILE" -o "$FILE_TO_SIGN.sig" "$FILE_TO_SIGN.srec"
